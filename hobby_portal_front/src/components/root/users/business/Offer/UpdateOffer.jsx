...
const UpdateOffer = () => {
  ...
  const validate = () => {
    ...
    if (!files.galleryImgUrl1) {
      errors.galleryImgUrl1 = "You must upload 4 high quality photos";
    }
    if (!files.galleryImgUrl2) {
      errors.galleryImgUrl2 = "You must upload 4 high quality photos";
    }
    if (!files.galleryImgUrl3) {
      errors.galleryImgUrl3 = "You must upload 4 high quality photos";
    }
  ...
  const submitHandler = (event) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      const uploaders = filesToUpload.map(async (file) => {
        ...
        formData.append("tags", `dv6ktrxwv, hobby`);
